...
if (isset($_POST['update'])) {
    ...
    $stmt = $pdo->prepare("UPDATE surat SET nomor_surat = ?, satuan_kerja = ?, kode_klasifikasi = ?, sub_klasifikasi = ?, bulan = ?, tahun = ?, nomor_keluar = ?, tanggal_surat = ?, ringkasan_isi_surat = ?, file_surat = ? WHERE id = ?");
