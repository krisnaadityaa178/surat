...
if (isset($_POST['update'])) {
    ...
    $stmt = $pdo->prepare("UPDATE sk_keluar SET nomor_surat = ?, satuan_kerja = ?, kode_klasifikasi = ?, sub_klasifikasi = ?, bulan = ?, tahun = ?, nomor_keluar = ?, tanggal_surat = ?, ringkasan_isi_surat = ?, file_surat = ? WHERE id = ?");
...
<head>
    ...
    <script>
        ...
        function goBack() {
            window.location.href = 'sk_keluar.php';
        }
    </script>
</head>
<body>
