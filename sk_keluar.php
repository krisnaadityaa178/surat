...
<body>
    ...
    <div class="content">
        <div class="header">
            ...
            <a href="javascript:void(0);" class="btn btn-view" id="openModalBtn">+ Tambah Surat Keputusan Keluar</a>
        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <a href="edit_sk_keluar.php?id=<?= $sk['id'] ?>" class="btn btn-edit">Edit</a>
                        <a href="sk_keluar.php?delete_id=<?= $sk['id'] ?>" class="btn btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus surat ini?')">Delete</a>
                    </div>
                </td>
            </tr>
            <?php endforeach; ?>
    ...
    <!-- Modal untuk menambahkan Surat Keputusan Keluar -->
    <div id="addModal" class="modal">
        <div class="modal-content">
            <span class="close-btn">&times;</span>
            <h3>Tambah Surat Keputusan Keluar</h3>
    ...
    <script>
        ...
        // When the user clicks the "Add New Surat Keputusan Keluar" button, open the modal
